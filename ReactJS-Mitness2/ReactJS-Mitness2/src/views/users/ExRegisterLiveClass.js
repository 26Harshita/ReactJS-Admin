...
export default class ExRegisterLiveClass extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div>
        ...
        <form onSubmit={this.onSubmit}>
          ...
          <div className="form-group" style={{ width: "450px" }}>
            <label>Close Class If Minimum Participant Is Not Met </label>
            <div>
