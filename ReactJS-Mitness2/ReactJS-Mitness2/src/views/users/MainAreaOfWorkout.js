...
export default class MainAreaOfWorkout extends Component {
  constructor(props) {
    super(props);
  ...
  customerList() {
    ...
    return this.state.customers.map((currentcustomer) => (
      <tr>
        ...
        {/* <td style={{ border: "1px double grey", textAlign: "center" }}>
          {currentcustomer.notice}
        </td>
        <td style={{ border: "1px double grey", textAlign: "center" }}>
          {currentcustomer.registeredDate}
        </td>
        <td style={{ border: "1px double grey", textAlign: "center" }}>
          ...
          <div class="row">
            <div class="col-md">
              <div style={{ display: "flex" }}>
                ...
                {/* <div style={{ width: "9%" }}>
                  <Link to="/RegisterEvent" className="nav-link">
                    <button
                      type="submit"
                      value="AddNewTrainer"
